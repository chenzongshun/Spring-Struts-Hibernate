...
MySQL - 5.7.20-log : Database - 18-04-08-bos
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`18-04-08-bos` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
('4028808d630073f0016300762c1a0002','修改取派员','staff-edit','修改取派员','/StaffAction.editStaff','0',123,'113'),
('4028808d6304e6f0016304eae14a0000','取派员列表','staff-list','','/StaffAction','0',123,'113'),
...
('111','超级管理员','超级','超级管理员'),
('4028808d63021d720163022289480000','普通管理员','普通','就是普通的'),
('4028808d6304e6f0016304eeb1f50001','取派员所有权','StaffAll','取派员所有权'),
('4028808d630729be01630737fe320000','基础档案','基础档案','只有基础档案权限的角色');
...
('0002','昌','4028808d62c83dc70162c853f1cf0000'),
('zoneid','zonename','4028808d62c8cf9d0162c8f823300003');
...
('4028808d62c4bdbc0162c4bee2f60000','小李','13007322150','0','1','单位','取派标准'),
('4028808d62c83dc70162c853f1cf0000','小刘','13007322150','0','0','单位','取派标准'),
('4028808d62c8cf9d0162c8f823300003','陈宗顺','13007322150','1','0','娄底职业技术学院','10000');
...
('4028808d62d4199d0162d41a3bf20000','0002','QY005','昌','1','100','2','昌平'),
('4028808d62dca9480162dcac9ed00000','zoneid','QY048','西','10','100','2','天津'),
('4028808d62e0a30d0162e0a4e4100000','zoneid','QY054','静海','1','100','0','天津静海');
...
('4028808d62f254890162f25527da0000','4028808d62c8cf9d0162c8f823300003','10','陈顺','陈顺','13007322150','湖南娄底楼职业技术学院','','','2018-04-23',NULL,NULL,'','','自动分单','1');
...
('4028808d62f254890162f25528cd0001','4028808d62f254890162f25527da0000','新','未取件','2018-04-23 19:48:10',0,'','4028808d62c8cf9d0162c8f823300003');
...
('1','1','1',1,1,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `role_function` (
  ...
  KEY `FK_Reference_21` (`function_id`),
  CONSTRAINT `FK_Reference_21` FOREIGN KEY (`function_id`) REFERENCES `auth_function` (`id`),
  CONSTRAINT `FK_Reference_31` FOREIGN KEY (`role_id`) REFERENCES `auth_role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `role_function` */

insert  into `role_function`(`role_id`,`function_id`) values 
('4028808d63021d720163022289480000','11'),
('4028808d6304e6f0016304eeb1f50001','11'),
('4028808d630729be01630737fe320000','11'),
('4028808d63021d720163022289480000','112'),
('4028808d630729be01630737fe320000','112'),
('4028808d63021d720163022289480000','113'),
('4028808d6304e6f0016304eeb1f50001','113'),
('4028808d630729be01630737fe320000','113'),
('4028808d63021d720163022289480000','114'),
('4028808d630729be01630737fe320000','114'),
('4028808d63021d720163022289480000','115'),
('4028808d630729be01630737fe320000','115'),
('4028808d63021d720163022289480000','116'),
('4028808d630729be01630737fe320000','116'),
('111','13'),
('111','131'),
('111','132'),
('4028808d63021d720163022289480000','4028808d630073f0016300762c1a0002'),
('4028808d6304e6f0016304eeb1f50001','4028808d630073f0016300762c1a0002'),
('4028808d630729be01630737fe320000','4028808d630073f0016300762c1a0002'),
('4028808d6304e6f0016304eeb1f50001','4028808d6304e6f0016304eae14a0000'),
('4028808d630729be01630737fe320000','4028808d6304e6f0016304eae14a0000'),
('4028808d63021d720163022289480000','8a7e843355a4392d0155a43aa7150000'),
('4028808d6304e6f0016304eeb1f50001','8a7e843355a4392d0155a43aa7150000'),
('4028808d630729be01630737fe320000','8a7e843355a4392d0155a43aa7150000');
...
('1','shun','125565a5ed9dcc02a5ce69f12a07a533',NULL,NULL,NULL,NULL,'13007322150',NULL),
('4028808d6304e6f0016304f1b43c0002','qpy','26b9011b00edd7127fede03c328aeb83',2000,'2018-04-03','','基地运转中心','13007322150',''),
('4028808d630729be01630738ec4f0001','jc','b7adde8a9eec8ce92b5ee0507ce054a4',1000,'2018-04-27','男','总公司','11111111111','只有基础档案权限的角色，用于测试首页菜单栏所拥有的功能们'),
('fasdf','admin','21232f297a57a5a743894a0e4a801fc3',NULL,'2018-04-18','女','总公司','13007322150','admin内置账户');
...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `FK_Reference_41` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`),
  CONSTRAINT `FK_Reference_51` FOREIGN KEY (`role_id`) REFERENCES `auth_role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `user_role` */

insert  into `user_role`(`user_id`,`role_id`) values 
('4028808d6304e6f0016304f1b43c0002','4028808d6304e6f0016304eeb1f50001'),
('4028808d630729be01630738ec4f0001','4028808d630729be01630737fe320000');
